    ...
    if "excel_bytes" not in st.session_state:
        ...
        try:
            ...
            if client_data_file:
                ...
                # Ensure both files are wrapped in BytesIO before passing to efocus_focus
                ...
                transformed_file, selected_client = efocus_focus(file_bytes_io, client_data_bytes_io)
